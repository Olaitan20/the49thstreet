...
export default function Store() {
  ...
  return (
    <div className="bg-white md:bg-transparent mx-0 sm:mx-6 md:mx-8 lg:mx-16 md:my-10 pt-8">
      ...
      <div className="pb-4 md:pb-8 px-4 md:px-0 flex justify-between items-center">
        <div>
          ...
          <p className="text-[16px] uppercase font-extrabold text-black md:text-white">
            Stop by the store
          </p>
        </div>
      ...
      {/* ✅ Visit Shop Footer with Link */}
      <Link
        href="/shop"
        className="text-center text-[14px] py-4 bg-black flex items-center  justify-center gap-2 capitalize text-sm mt-6 font-semibold hover:underline text-white"
      >
        <p>Visit shop</p>
